...
{{--    </form>--}}
    ...
    <form method="post" action="{{ route('admins.update', $admin->id) }}" class="mt-6 space-y-6">
        @csrf
        @method('put')
        ...
        <div>
            ...
            <x-text-input id="phone" name="phone" type="tel" class="mt-1 block w-full" :value="old('phone', $admin->phone)" required />
            <x-input-error class="mt-2" :messages="$errors->get('email')" />
        </div>
